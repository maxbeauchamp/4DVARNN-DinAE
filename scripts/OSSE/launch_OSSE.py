...
opt = "nadirswot"  # sys.argv[1]            # nadir/swot/nadirswot
lag = 5  # sys.argv[2]            # 0...5
type_obs = "obs"  # sys.argv[3]            # mod/obs
domain = "GULFSTREAM"  # sys.argv[4]            # OSMOSIS/GULFSTREAM
wMis = 1  # int(sys.argv[5])       # 0/1/2
wCov = True  # str2bool(sys.argv[6])  # False/True
# %%
...
#%%
    ...
    with open('scripts/OSSE/config.yml', 'rb') as f:
    ...
    dirSAVE = '/users/local/q20febvr/4dnvarnn/out'
    ...
    pickle.dump(
        {
         ...
         'x_test_OI': x_test_OI,
          ...
          'gt_train': gt_train,
          'x_train_missing': x_train_missing,
          'x_train_OI': x_train_OI,
         }, f
    )
